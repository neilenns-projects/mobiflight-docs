...
{{< screenshot image="definer_devices.png" title="Device list in definer tool." >}}
...
{{< screenshot image="definer_bases.png" title="List of bases as shown in definer tool." >}}
...
{{< screenshot image="definer_addons.png" title="List of modules as shown in definer tool." >}}
...
{{< screenshot image="definer_stecspreset.png" title="List of STECS MTG-R presets." >}}
...
{{< screenshot image="definer_modulebuttons.png" title="Button ID prompt." >}}
...
{{< screenshot image="definer_moduleleds.png" title="LED ID prompt." >}}
...
{{< screenshot image="definer_encoderapi.png" title="Enable the encoder API." >}}
...
{{< screenshot image="definer_done.png" title="Finished creating definition file." >}}
