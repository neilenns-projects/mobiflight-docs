...
{{< screenshot image="alt-device-assignment.png" title="Screenshot of an input config for the right knob - ALT decrement input." >}}
...
{{< screenshot image="alt-precondition.png" title="Screenshot of the precondition for the right knob - ALT decrement input config." >}}
